  ...
  return NextResponse.json(
    {
      error: "Gone",
      message:
        "Long-form documentation now lives in the standalone Mzizi docs site. See GET /api/v1/docs for the per-slug → URL migration map, or browse https://docs.bundu.org/mzizi.",
      slug,
    },
